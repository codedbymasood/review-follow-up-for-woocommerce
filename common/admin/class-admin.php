...
class Admin {
	...
	private function __construct() {
		add_filter(
			...
			function ( $plugins = array() ) {
				$plugins[] = 'review-follow-up-for-wooCommerce';
	...
	public function send_review_request_email( $email, $order ) {
		...
		$subject     = get_option( 'revifoup_review_request_email_subject', esc_html__( 'How was your order? We\'d love your feedback.', 'review-follow-up-for-wooCommerce' ) );
		$heading     = get_option( 'revifoup_review_request_email_heading', esc_html__( 'Quick favor? We\'d love your feedback!', 'review-follow-up-for-wooCommerce' ) );
		$footer_text = get_option( 'revifoup_review_request_email_footer_text', esc_html__( 'Thanks again for choosing us!', 'review-follow-up-for-wooCommerce' ) );
...
The {site_name} Team",
	...
	public function send_followup_email( $email = '', $order = null ) {
		...
		$subject     = get_option( 'revifoup_review_request_email_subject', esc_html__( 'Review + Save: {discount} discount waiting for you', 'review-follow-up-for-wooCommerce' ) );
		$heading     = get_option( 'revifoup_review_followup_email_heading', esc_html__( 'Review Your Order & Get {discount} Off Your Next Purchase!', 'review-follow-up-for-wooCommerce' ) );
...
The {site_name} Team",
	...
	public function render_review_request_page() {
		$args = array(
			'title'      => esc_html__( 'Review Requests', 'review-follow-up-for-wooCommerce' ),
			'singular'   => 'request',
			'plural'     => 'requests',
