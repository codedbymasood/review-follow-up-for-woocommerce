...
The {site_name} Team';
		...
		$fields = array(
			esc_html__( 'Review Request Email', 'review-follow-up-for-wooCommerce' ) => array(
				array(
				...
				array(
					...
					'label'   => esc_html__( 'Heading', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'text',
				...
				array(
					...
					'label'          => esc_html__( 'Email Content', 'review-follow-up-for-wooCommerce' ),
				...
				array(
					...
					'label'   => esc_html__( 'Footer Text', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'textarea',
					'default' => esc_html__( 'Thanks again for choosing us!', 'review-follow-up-for-wooCommerce' ),
				),
			),
			esc_html__( 'Final Followup Email', 'review-follow-up-for-wooCommerce' ) => array(
				array(
					'id'      => 'revifoup_review_followup_email_subject',
					'label'   => esc_html__( 'Subject', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'text',
					'default' => esc_html__( 'Review + Save: {discount} discount waiting for you', 'review-follow-up-for-wooCommerce' ),
				),
				array(
					'id'      => 'revifoup_review_followup_email_heading',
					'label'   => esc_html__( 'Heading', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'text',
					'default' => esc_html__( 'Review Your Order & Get {discount} Off Your Next Purchase!', 'review-follow-up-for-wooCommerce' ),
				),
				array(
			...
			esc_html__( 'Review Reward Email', 'review-follow-up-for-wooCommerce' ) => array(
				array(
					'id'      => 'revifoup_review_reward_email_subject',
					'label'   => esc_html__( 'Subject', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'text',
					'default' => esc_html__( 'Your {discount} discount code is here! 🎉', 'review-follow-up-for-wooCommerce' ),
				),
				array(
					'id'      => 'revifoup_review_reward_email_heading',
					'label'   => esc_html__( 'Heading', 'review-follow-up-for-wooCommerce' ),
					'type'    => 'text',
					'default' => esc_html__( 'Thank You for Your Review! Here\'s Your {discount} Discount Code', 'review-follow-up-for-wooCommerce' ),
				),
				array(
		...
		new Settings(
			...
			esc_html__( 'Email Templates', 'review-follow-up-for-wooCommerce' ),
			esc_html__( 'Email Templates', 'review-follow-up-for-wooCommerce' ),
			'manage_woocommerce',
			'',
			0,
