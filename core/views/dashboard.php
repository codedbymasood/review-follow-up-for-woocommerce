...
<div class="stobokit-wrapper no-spacing">
	<div class="wrap">
		<h2><?php esc_html_e( 'Welcome to Store Boost Kit', 'review-follow-up-for-wooCommerce' ); ?></h2>

		<div class="stobokit-widgets">

			<!-- Quick Links Widget -->
			<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Quick Links', 'review-follow-up-for-wooCommerce' ); ?></h3>
					<ul>
							<li><a href="https://storeboostkit.com/support-form" target="_blank"><?php esc_html_e( 'Support', 'review-follow-up-for-wooCommerce' ); ?></a></li>
							<li><a href="https://help.storeboostkit.com" target="_blank"><?php esc_html_e( 'Help Desk', 'review-follow-up-for-wooCommerce' ); ?></a></li>
							<li><a href="https://storeboostkit.com/frequently-asked-questions" target="_blank"><?php esc_html_e( 'FAQ', 'review-follow-up-for-wooCommerce' ); ?></a></li>
							<li><a href="https://storeboostkit.com/account" target="_blank"><?php esc_html_e( 'My Account', 'review-follow-up-for-wooCommerce' ); ?></a></li>
					</ul>
			</div>
			...
			if ( ! empty( $product_lists ) ) {
				...
				<!-- Licenses Widget -->
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Licenses', 'review-follow-up-for-wooCommerce' ); ?></h3>
					<?php
					$inactive_count = 0;
					$expired_count  = 0;
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=stobokit-license' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Manage Licenses', 'review-follow-up-for-wooCommerce' ); ?></a>
				</div>
				<?php
			}
			?>
			...
			<?php if ( ! empty( $recent_posts ) ) : ?>
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'News & Updates', 'review-follow-up-for-wooCommerce' ); ?></h3>
					<ul>
			...
			<?php if ( ! empty( $announcement_posts ) ) : ?>
				<div class="stobokit-widget">
					<h3><?php esc_html_e( 'Announcements & Promotions', 'review-follow-up-for-wooCommerce' ); ?></h3>
					<ul>
						<?php
