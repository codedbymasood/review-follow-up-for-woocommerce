...
class Admin {
    ...
    // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
		...
		wp_send_json_success(
			array(
				'message' => esc_html__( 'Settings saved!', 'review-follow-up-for-wooCommerce' ),
			)
		);
	...
	public function admin_menu() {
		...
		add_menu_page(
			esc_html__( 'Store Boost Kit', 'review-follow-up-for-wooCommerce' ),
			esc_html__( 'Store Boost Kit', 'review-follow-up-for-wooCommerce' ),
			'manage_woocommerce',
			'stobokit-dashboard',
		...
		add_submenu_page(
			'stobokit-dashboard',
			esc_html__( 'Dashboard', 'review-follow-up-for-wooCommerce' ),
			esc_html__( 'Dashboard', 'review-follow-up-for-wooCommerce' ),
			'manage_woocommerce',
			'stobokit-dashboard',
			array( $this, 'dashboard' )
		...
		add_submenu_page(
			'stobokit-dashboard',
			esc_html__( 'Status', 'review-follow-up-for-wooCommerce' ),
			esc_html__( 'Status', 'review-follow-up-for-wooCommerce' ),
			'manage_woocommerce',
			'stobokit-status',
			array( $this, 'status' )
		...
		if ( ! empty( $product_lists ) ) {
			add_submenu_page(
				'stobokit-dashboard',
				esc_html__( 'License', 'review-follow-up-for-wooCommerce' ),
				esc_html__( 'License', 'review-follow-up-for-wooCommerce' ),
				'manage_woocommerce',
				'stobokit-license',
				array( $this, 'license' )
