		...
		<div class="stobokit-wrapper wrap">
			...
			if ( isset( $_GET['settings-updated'] ) ) :
				...
				<div class="stobokit-notice">
					<p><?php esc_html_e( 'Settings saved successfully!', 'review-follow-up-for-wooCommerce' ); ?></p>
				</div>
				<?php
			endif;
			?>
			...
			<div class="nav-tab-wrapper horizontal">
				...
				<div class="nav-tab-content-wrapper">
					<form method="post">
						...
						<?php endforeach; ?>
						<?php submit_button( esc_html__( 'Save Settings', 'review-follow-up-for-wooCommerce' ) ); ?>
					</form>
				</div>
			</div>
		</div>
				...
				case 'richtext_editor':
					...
					if ( in_array( array( 'html', 'css' ), array( $field['options'] ), true ) ) {
						echo '<ul class="tab-nav">';
							echo '<li data-type="html" class="' . ( ( 'html' === $default_editor ) ? 'active' : '' ) . '">' . esc_html__( 'HTML', 'review-follow-up-for-wooCommerce' ) . '</li>';
							echo '<li data-type="css" class="' . ( ( 'css' === $default_editor ) ? 'active' : '' ) . '">' . esc_html__( 'CSS', 'review-follow-up-for-wooCommerce' ) . '</li>';
						echo '</ul>';
					}
