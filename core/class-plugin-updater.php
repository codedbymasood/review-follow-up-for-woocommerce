...
class Plugin_Updater {
	...
	public function show_update_notification( $file, $plugin ) {
		...
		printf(
			...
			esc_html__( 'There is a new version of %1$s available.', 'review-follow-up-for-wooCommerce' ),
			esc_html( $plugin['Name'] )
		);

		if ( ! current_user_can( 'update_plugins' ) ) {
			echo ' ';
			esc_html_e( 'Contact your network administrator to install the update.', 'review-follow-up-for-wooCommerce' );
			...
			printf(
				...
				esc_url( wp_nonce_url( $update_link, 'upgrade-plugin_' . $file ) ),
				esc_html__( 'Update now.', 'review-follow-up-for-wooCommerce' )
			);
		}
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'review-follow-up-for-wooCommerce' ), esc_html__( 'Error', 'review-follow-up-for-wooCommerce' ), array( 'response' => 403 ) );
		}
