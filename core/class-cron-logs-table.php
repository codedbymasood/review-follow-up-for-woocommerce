...
class Cron_Logs_Table extends \STOBOKIT\List_Table {
	...
	public function custom_columns() {
		return array(
			...
			'hook_name'  => esc_html__( 'Hook', 'review-follow-up-for-wooCommerce' ),
			'status'     => esc_html__( 'Status', 'review-follow-up-for-wooCommerce' ),
			'args'       => esc_html__( 'Arguments', 'review-follow-up-for-wooCommerce' ),
			'created_at' => esc_html__( 'Created At', 'review-follow-up-for-wooCommerce' ),
			'schedule'   => esc_html__( 'Schedule', 'review-follow-up-for-wooCommerce' ),
			'next_run'   => esc_html__( 'Next Run', 'review-follow-up-for-wooCommerce' ),
		);
	}
