...
require_once STOBOKIT_PATH . '/class-cron-scheduler.php';
require_once STOBOKIT_PATH . '/class-email-logs-table.php';
...
require_once STOBOKIT_PATH . '/class-plugin-deactivation-feedback.php';
